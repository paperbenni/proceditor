...
class PROCEDITOR_OT_add_text(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        newclip = bpy.context.scene.sequence_editor.sequences.new_effect(
            ...
            frame_end=bpy.context.scene.frame_current + 20,
            channel=gettopchannel(bpy.context.scene.frame_current))
        ...
        bpy.context.scene.sequence_editor.active_strip = newclip
